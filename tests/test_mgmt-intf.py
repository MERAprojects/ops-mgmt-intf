...
class mgmtIntfTests( OpsVsiTest ):
    ...
    def mgmt_intf_updated_during_bootup(self):
        ...
        info('### Successfully verified mgmt interface has updated from image.manifest file ###\n')
    ...
    def mgmt_intf_context_enter(self):
        ...
        assert 'Unknown command' not in output,'Test to enter the management interface context failed'
        info('### Successfully verified enter into the management interface context ###\n')
    ...
    def config_default_gateway_ipv4_dhcp_mode(self):
        ...
        info('### Successfully verified configuration of Deafult gateway in DHCP mode ###\n')
    ...
    def config_primary_ipv4_dns_dhcp_mode(self):
        ...
        info('### Successfully verified configuration of Primary DNS in DHCP mode ###\n')
    ...
    def config_secondary_ipv4_dns_dhcp_mode(self):
        ...
        info('### Successfully verified configuration of Secondary DNS in DHCP mode ###\n')
    ...
    def config_ipv4_on_mgmt_intf_static_mode(self):
        ...
        info('### Successfully configured static IP address in static mode ###\n')
    ...
    def reconfig_ipv4_on_mgmt_intf_static_mode(self):
        ...
        info('### Successfully Reconfigured static IP address in static mode ###\n')
    ...
    def config_ipv4_default_gateway_static_mode(self):
        ...
        info('### Successfully configured Default gateway in static mode ###\n')
    ...
    def config_ipv6_default_gateway_ipv4_is_set_static_mode(self):
        ...
        info('### Successfully verified configuration of IPV6 default gateway when IPV4 is configured in static mode ###\n')
    ...
    def reconfig_secondary_ipv4_dns_static_mode(self):
        ...
        info('### Successfully Reconfigured Secondary DNS in static mode ###\n')
    ...
    def config_invalid_ipv4_on_mgmt_intf(self):
        ...
        info('### Successfully verified configure of Invalid IP in static mode ###\n')
    ...
    def config_multicast_ipv4_on_mgmt_intf(self):
        ...
        info('### Successfully verified configure of multicast IP in static mode ###\n')
    ...
    def config_broadcast_ipv4_on_mgmt_intf(self):
        ...
        info('### Successfully verified configure of broadcast IP in static mode ###\n')
    ...
    def config_loopback_ipv4_on_mgmt_intf(self):
        ...
        info('### Successfully verified configure of loopback IP in static mode ###\n')
    ...
    def config_invalid_default_gateway_ipv4_static_mode(self):
        ...
        info('### Successfully Verified configure of Invalid default gateway IP in static mode ###\n')
    ...
    def config_multicast_ipv4_default_gateway_static_mode(self):
        ...
        info('### Successfully Verified configure of multicast default gateway IP in static mode ###\n')
    ...
    def config_broadcast_ipv4_default_gateway_static_mode(self):
        ...
        info('### Successfully Verified configure of broadcast default gateway in static mode ###\n')
    ...
    def config_loopback_ipv4_default_gateway_static_mode(self):
        ...
        info('### Successfully Verified configure of loopback default gateway in static mode ###\n')
    ...
    def config_invalid_primary_ipv4_dns_static_mode(self):
        ...
        info('### Successfully Verified configure of invalid Primary DNS in static mode ###\n')
    ...
    def config_multicast_ipv4_primary_dns_static_mode(self):
        ...
        info('### Successfully Verified configure of multicast Primary DNS in static mode ###\n')
    ...
    def config_broadcast_ipv4_primary_dns_static_mode(self):
        ...
        info('### Successfully Verified configure of broadcast Primary DNS in static mode ###\n')
    ...
    def config_loopback_primary_ipv4_dns_static_mode(self):
        ...
        info('### Successfully Verified configure of loopback Primary DNS in static mode ###\n')
    ...
    def config_invalid_ipv4_secondary_dns_static_mode(self):
        ...
        info('### Successfully Verified configure of invalid secondary DNS in static mode ###\n')
    ...
    def ipv4_got_after_populated_ipv4_config(self):
        ...
        info('### Successfully got the IP after changed the mode from static to dhcp ###\n')
    ...
    def ipv4_default_gateway_got_after_populated_ipv4_config(self):
        ...
        info('### Successfully got Default gateway IP after changed the mode from static to dhcp ###\n')
    ...
    def dns_ipv4_got_after_populated_ipv4_config(self):
        ...
        info('### Successfully got DNS IP after changed the mode from static to dhcp ###\n')
    ...
    def config_default_gateway_ipv6_dhcp_mode(self):
        ...
        info('### Successfully verified configure of default gateway in DHCP mode ###\n')
    ...
    def config_primary_ipv6_dns_dhcp_mode(self):
        ...
        info('### Successfully verified configure of Primary DNS in DHCP mode ###\n')
    ...
    def config_secondary_ipv6_dns_dhcp_mode(self):
        ...
        info('### Successfully verified configure of Secondary DNS in DHCP mode ###\n')
    ...
    def config_invalid_ipv6_on_mgmt_intf(self):
        ...
        info('### Successfully verified configure of invalid static IP address ###\n')
    ...
    def config_multicast_ipv6_on_mgmt_intf(self):
        ...
        info('### Successfully verified configure of multicast IP address in static mode ###\n')
    ...
    def config_link_local_ipv6_on_mgmt_intf(self):
        ...
        info('### Successfully verified configure of link-local IP in static mode ###\n')
    ...
    def config_loopback_ipv6_on_mgmt_intf(self):
        ...
        info('### Successfully verified configure of loopback IP address in static mode ###\n')
    ...
    def config_ipv6_default_gateway_static_mode(self):
        ...
        info('### Successfully verified configure of default gateway in static mode ###\n')
    ...
    def config_ipv4_default_gateway_ipv6_is_set_static_mode(self):
        ...
        info('### Successfully verified configuration of IPV4 default gateway when IPV6 is configured in static mode ###\n')
    ...
    def config_multicast_ipv6_default_gateway_static_mode(self):
        ...
        info('### Successfully verified configure of multicast gateway ip in static mode ###\n')
    ...
    def config_default_linl_local_ipv6_gateway_static_mode(self):
        ...
        info('### Successfully verified configure of Default link-local  gateway ip in static mode ###\n')
    ...
    def config_loopback_ipv6_default_gateway_static_mode(self):
        ...
        info('### Successfully verified configure of Default loopback gateway in static mode ###\n')
    ...
    def config_invalid_primary_ipv6_dns_static_mode(self):
        ...
        info('### Successfully verified configure of invalid Primary DNS static mode ###\n')
    ...
    def config_link_local_ipv6_primary_dns_static_mode(self):
        ...
        info('### Successfully verified configure of link-local primary DNS in static mode ###\n')
    ...
    def config_multicast_ipv6_secondary_dns_static_mode(self):
        ...
        info('### Successfully verified configure of multicast secondary DNS in static mode ###\n')
    ...
    def config_link_local_ipv6_secondary_dns_static_mode(self):
        ...
        info('### Successfully verified configure of link-local secondary DNS in static mode ###\n')
    ...
    def config_loopback_ipv6_secondary_dns_static_mode(self):
        ...
        info('### Successfully verified configure of loopback secondary DNS in static mode ###\n')
    ...
    def config_same_ipv6_primary_secondary_dns_static_mode(self):
        ...
        info('### Successfully verified configure of same primary and secondary DNS in static mode ###\n')
    ...
    def config_primary_ipv6_dns_static_mode(self):
        ...
        info('### Successfully configured the Primary DNS in static mode ###\n')
    ...
    def reconfig_primary_ipv6_dns_static_mode(self):
        ...
        info('### Successfully Reconfigured the Primary DNS in static mode ###\n')
    ...
    def ipv6_got_after_populated_ipv6_config(self):
        ...
        info('### Successfully got IP after changed the mode from static to dhcp ###\n')
    ...
    def ipv6_default_gateway_got_after_populated_ipv6_config(self):
        ...
        info('### Successfully got the Default gateway after changed the mode Passed ###\n')
    ...
    def remove_ipv4_on_mgmt_intf_static_mode(self):
        ...
        while cnt:
            ...
            output += s1.cmd("echo")
            show_output = output
            if IPV4_static not in output and self.Dhcp_Ipv4_submask[1] not in output:
                cnt2 = 15
                while cnt2:
                    output = s1.cmd("ifconfig")
                    output += s1.cmd("echo")
                ...
                sleep(1)
                cnt -= 1
        assert IPV4_static not in output,'Test to remove static IP address in static mode failed'
        subnet = (1<<32) - (1<<32>>int(self.Dhcp_Ipv4_submask[1]))
        ...
        assert 'dhcp' in show_output,\
                'DHCP mode change failed.Test to remove static IP address in static mode failed'
    ...
    def remove_ipv4_on_mgmt_intf_with_ipv6(self):
        ...
        IPV4_static = re.sub('\d+$','128', self.Dhcp_Ipv4_submask[0])
        s1.cmdCLI("ip static "+IPV4_static+"/"+self.Dhcp_Ipv4_submask[1])
        cmd_output = s1.cmdCLI("no ip static "+IPV4_static+"/"+self.Dhcp_Ipv4_submask[1])
        ...
        while cnt:
            ...
            if IPV4_static not in output and self.Dhcp_Ipv4_submask[1] not in output:
                ...
                sleep(1)
                cnt -= 1
        assert IPV4_static not in output,'Test to remove static IP address with IPv6 failed'
        subnet = (1<<32) - (1<<32>>int(self.Dhcp_Ipv4_submask[1]))
        assert self.numToDottedQuad(subnet) not in output,\
        ...
        info('### Successfully removed IP address with static IPv6 address  ###\n')
    ...
    def remove_ipv4_on_mgmt_intf_with_def_gw(self):
        ...
        while cnt:
            ...
            if IPV4_static in output and self.Dhcp_Ipv4_submask[1] in output:
                ...
                sleep(1)
                cnt -= 1
        assert IPV4_static in output,'Test to remove static IP address with default gateway in static mode failed'
        subnet = (1<<32) - (1<<32>>int(self.Dhcp_Ipv4_submask[1]))
        assert self.numToDottedQuad(subnet) in output,\
                'Test to remove static IP address with default gateway in static mode failed'
        assert "Remove all IPv4 static configurations" in cmd_output,\
                'Test to remove static IP address with default gateway in static mode failed'
        info('### Successfully verified to remove IP address with default gateway in static mode ###\n')
    ...
    def remove_ipv4_on_mgmt_intf_with_nameserver(self):
        ...
        while cnt:
            ...
            if IPV4_static in output and self.Dhcp_Ipv4_submask[1] in output:
                ...
                sleep(1)
                cnt -= 1
        assert IPV4_static in output,'Test to remove static IP address with name server in static mode failed'
        subnet = (1<<32) - (1<<32>>int(self.Dhcp_Ipv4_submask[1]))
        assert self.numToDottedQuad(subnet) in output,\
                'Test to remove static IP address with name server in static mode failed'
        assert "Remove all IPv4 static configurations" in cmd_output,\
                'Test to remove static IP address with name server in static mode failed'
        info('### Successfully verified to remove IP address with name server in static mode ###\n')
    ...
    def remove_ipv4_on_mgmt_intf_with_nameserver_ipv6(self):
        ...
        assert self.numToDottedQuad(subnet) in output,\
                'Test to remove static IP address with name server in static mode failed'
        assert "Remove all IPv4 static configurations" in cmd_output,\
                'Test to remove static IP address with mixed name server in static mode failed'
        info('### Successfully verified to remove IP address with IPv6 name server in static mode ###\n')
    ...
    def remove_ipv6_on_mgmt_intf_static_mode(self):
        ...
        while cnt:
            ...
            if '2001:db8:0:1::156/64' not in output:
                ...
                sleep(1)
                cnt -= 1
        assert '2001:db8:0:1::156/64' not in output,'Test to remove static IPv6 address failed'
        assert 'dhcp' in show_output,\
                'DHCP mode change failed.Test to remove static IPv6 address in static mode failed'
    ...
    def remove_ipv6_on_mgmt_intf_with_ipv4(self):
        ...
        while cnt:
            ...
            if '2001:db8:0:1::156/64' not in output:
                ...
                sleep(1)
                cnt -= 1
        assert '2001:db8:0:1::156/64' not in output,'Test to remove static IPv6 address with Ipv4 failed'
        assert 'static' in show_output,\
    ...
    def remove_ipv6_on_mgmt_intf_with_def_gw(self):
        ...
        while cnt:
            ...
            if '2001:db8:0:1::156/64' in output:
                ...
                sleep(1)
                cnt -= 1
        assert '2001:db8:0:1::156/64' in output,'Test to remove static IPv6 address with default gw failed'
        assert 'Remove all IPv6 static configurations' in cmd_output,\
                'Test to remove static IPv6 address with default gw failed'
        info('### Successfully verified to remove Static IPv6 with default gw ###\n')
    ...
    def remove_ipv6_on_mgmt_intf_with_nameserver(self):
        ...
        while cnt:
            ...
            if '2001:db8:0:1::156/64' in output:
                ...
                sleep(1)
                cnt -= 1
        assert '2001:db8:0:1::156/64' in output,'Test to remove static IPv6 address with name server failed'
        assert 'Remove all IPv6 static configurations' in cmd_output,\
                'Test to remove static IPv6 address with name server failed'
        info('### Successfully verified to remove Static IPv6 with name server ###\n')
    ...
    def remove_ipv6_on_mgmt_intf_with_nameserver_ipv4(self):
        ...
        while cnt:
            ...
            if '2001:db8:0:1::156/64' in output:
                ...
                sleep(1)
                cnt -= 1
        assert '2001:db8:0:1::156/64' in output,'Test to remove static IPv6 address with name server IPv4 failed'
        assert 'Remove all IPv6 static configurations' in cmd_output,\
                'Test to remove static IPv6 address with name server IPv4 failed'
        info('### Successfully verified to remove Static IPv6 with IPv4 name server ###\n')
...
class Test_mgmt_intf:
    ...
    def test_remove_ipv4_on_mgmt_intf_static_mode(self):
        info('\n########## Test to remove static IPv4 on management interface ##########\n')
    ...
    def test_remove_ipv6_on_mgmt_intf_static_mode(self):
        info('\n########## Test to remove static IPv6 on management interface ##########\n')
